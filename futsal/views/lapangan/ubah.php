					...
					<div class="col-sm-12">
						<div class="clearfix">
							<div class="float-left">
								<h1 class="h3 mb-4 text-gray-800">Ubah Tipe</h1>
							</div>
				...
				<div class="row">
					<div class="col-sm-6">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('lapangan/proses_ubah/' . $lapangan->id_lapangan) ?>" enctype="multipart/form-data">
								  	<div class="form-group">
										<label for="tipe">Nama tipe</label>
										<select name="id_tipe" id="tipe" class="form-control">
											<?php while($tipe = $data_tipe->fetch_object()) : ?>
												<option value="<?= $tipe->id ?>" <?= $lapangan->id_tipe == $tipe->id ? 'selected' : '' ?>><?= $tipe->tipe ?></option>
											<?php endwhile; ?>
										</select>
								  	</div>
								  	<div class="form-group">
								  		<label for="nama">Nama Lapangan</label>
								  		<input type="text" value="<?= $lapangan->nama ?>" name="nama" id="nama" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="row">
									  	<div class="form-group col-6">
									  		<label for="jumlah">Jumlah </label>
									  		<input type="number" value="<?= $lapangan->Jumlah ?>" name="jumlah" id="jumlah" required="required" placeholder="ketik" autocomplete="off" class="form-control">
									  	</div>
								  	</div>
								  	<div class="form-group">
