				...
				<div class="row">
					<div class="col-sm-4">
						<div class="card shadow">
							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('tipe/tambah') ?>">
								  	<div class="form-group">
										<label for="tipe">Tipe Lapangan</label>
										<input type="text" class="form-control" name="tipe" id="tipe" autocomplete="off" required="required" placeholder="ketik">
								  	</div>
								  	<div class="form-group">
					...
					<div class="col-sm-8">
						<div class="card shadow">
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-primary">Daftar Tipe Lapangan</h6>
							</div>
							<div class="card-body">
	                 				...
	                 				<tbody>
	                 					<?php while($tipe = $data_tipe->fetch_object()) : ?>
	                 						<tr>
	                 							...
	                 							<td><?= $tipe->tipe ?></td>
	                 							<td>
	                 								<a href="<?= base_url('tipe/ubah/' . $tipe->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
	                 								<a href="<?= base_url('tipe/hapus/' . $tipe->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
	                 							</td>
	                 						</tr>
	                 					<?php endwhile; ?>
	                 				</tbody>
