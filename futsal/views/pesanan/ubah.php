							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('pesanan/proses_ubah/' . $pesanan->id) ?>" enctype="multipart/form-data">
								  	...
								  	<div class="form-group">
								  		...
								  		<input type="text" disabled="disabled" class="form-control" value="<?= $lapangan->nama ?>">
								  	</div>

									<div class="form-group">
								  		<label for="id_waktu">Waktu</label>
								  		<input type="text" disabled="disabled" class="form-control" value="<?= $waktu->awal . ' - ' . $waktu->akhir ?>">
								  	</div>
